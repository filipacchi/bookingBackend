                                            ...
                                            renderItem={
                                                ({ item }) => (
                                                    <TouchableOpacity onPress={() => {
                                                        ...
                                                        navigation.navigate("BookableObject", { name: item['objectName'], id: item['objectId'], bookAhead: item['bookAheadWeeks'], token: state.userToken, perDay: item['slotsPerDay'], perWeek: item['slotsPerWeek']})
