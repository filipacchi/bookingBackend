# Generated by Django 4.2 on 2023-06-26 13:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_key', models.CharField(max_length=6, unique=True, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')])),
                ('coordinateX', models.FloatField(max_length=200)),
                ('coordinateY', models.FloatField(max_length=200)),
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=washbooking.models.upload_to)),
            ],
        ),
        migrations.CreateModel(
            name='BookableObject',
            fields=[
                ...
                ('bookableAfterLast', models.BooleanField(default=False)),
                ...
                ('inAssociation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='washbooking.association')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.CharField(default=washbooking.models.randomHex, editable=False, max_length=10)),
                ('used', models.BooleanField()),
                ('associationKey', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='washbooking.association')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='washbooking.bookableobject')),
                ('booked_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='washbooking.person')),
            ],
            options={
